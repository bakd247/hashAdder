...
Note: Best Performance using "pypy" I have not figured out why yet, but the newest versions of python run signifgantly slower than pypy does. I assume it has something to do with "type hinting" and / or "C-extensions" which is being added in the upcoming releases.
