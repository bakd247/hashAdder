...
Version 1.6 must be run as Administrator if using Linux Terminal..you must also install "tqdm" and "tinyec" using this command "sudo python3 -m install tinyec tqdm"..then run as root...
