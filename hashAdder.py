...
AA = int(input("Please Enter the Size of the Collision List you would like to Create. NOTE: The number you input will be doubled then squared (Example: input of 100 will OutPut - 40,000 total Keys Contained in the Multiples Collision List)(An input of 500 results in 1 million keys)...Please Consider This and keep your input number below 23,165 to prevent overflow Errors for Best Restults. Best Performance around 500...However Larger Nunbers are encouraged:"))
AAA = (AA * 2)
